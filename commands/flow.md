...
Gather raw facts. No interpretation.

- Read relevant files, check git status/log
- Collect error signals, logs, test failures
...
**Rules**:
- Use tools to gather real data — no assumptions
- Resolve critical unknowns before moving on
